...
import webservlet.Action.SendItemAction;

/**
 *
 * @author PhamTanLong
 */
public class SendItemController extends ServerServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            SendItemAction.responseDefault(resp);
        }
    }
    ...
    private void doProcess(HttpServletRequest req, HttpServletResponse resp) {
        ...
        {
            SendItemAction action = new SendItemAction();
