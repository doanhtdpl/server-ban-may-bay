...
public class ScribeService {
  ...
  public interface Iface {
    ...
    public scriberlog.ResultCode Log(List<scriberlog.LogEntry> messages) throws TException;

    public void Log2(List<scriberlog.LogEntry> messages) throws TException;

  }

  public interface AsyncIface {

    public void Log(List<scriberlog.LogEntry> messages, AsyncMethodCallback<AsyncClient.Log_call> resultHandler) throws TException;

    public void Log2(List<scriberlog.LogEntry> messages, AsyncMethodCallback<AsyncClient.Log2_call> resultHandler) throws TException;
  ...
  public static class Client implements TServiceClient, Iface {
    ...
    public void send_Log(List<scriberlog.LogEntry> messages) throws TException
    {
    ...
    public scriberlog.ResultCode recv_Log() throws TException
    {
    ...
    public void send_Log2(List<scriberlog.LogEntry> messages) throws TException
    {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void Log(List<scriberlog.LogEntry> messages, AsyncMethodCallback<Log_call> resultHandler) throws TException {
      checkReady();
    ...
    public static class Log_call extends TAsyncMethodCall {
      private List<scriberlog.LogEntry> messages;
      public Log_call(List<scriberlog.LogEntry> messages, AsyncMethodCallback<Log_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
      ...
      public scriberlog.ResultCode getResult() throws TException {
    ...
    public void Log2(List<scriberlog.LogEntry> messages, AsyncMethodCallback<Log2_call> resultHandler) throws TException {
      checkReady();
    ...
    public static class Log2_call extends TAsyncMethodCall {
      private List<scriberlog.LogEntry> messages;
      public Log2_call(List<scriberlog.LogEntry> messages, AsyncMethodCallback<Log2_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
  ...
  public static class Log_args implements TBase<Log_args, Log_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public List<scriberlog.LogEntry> messages;
    ...
    static {
      ...
      tmpMap.put(_Fields.MESSAGES, new FieldMetaData("messages", TFieldRequirementType.DEFAULT,
          new ListMetaData(TType.LIST,
              new StructMetaData(TType.STRUCT, scriberlog.LogEntry.class))));
    ...
    public Log_args(
      List<scriberlog.LogEntry> messages)
    {
      this();
      this.messages = messages;
    }
    ...
    public Log_args(Log_args other) {
      if (other.isSetMessages()) {
        List<scriberlog.LogEntry> __this__messages = new ArrayList<scriberlog.LogEntry>();
        for (scriberlog.LogEntry other_element : other.messages) {
          __this__messages.add(new scriberlog.LogEntry(other_element));
        }
    ...
    public java.util.Iterator<scriberlog.LogEntry> getMessagesIterator() {
      return (this.messages == null) ? null : this.messages.iterator();
    }

    public void addToMessages(scriberlog.LogEntry elem) {
      if (this.messages == null) {
        this.messages = new ArrayList<scriberlog.LogEntry>();
      }
      this.messages.add(elem);
    }

    public List<scriberlog.LogEntry> getMessages() {
      return this.messages;
    }

    public Log_args setMessages(List<scriberlog.LogEntry> messages) {
      this.messages = messages;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case MESSAGES:
        if (value == null) {
          ...
          setMessages((List<scriberlog.LogEntry>)value);
        }
        break;
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.messages = new ArrayList<scriberlog.LogEntry>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  scriberlog.LogEntry _elem10;
                  _elem10 = new scriberlog.LogEntry();
                  _elem10.read(iprot);
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.messages != null) {
        oprot.writeFieldBegin(MESSAGES_FIELD_DESC);
        {
          ...
          for (scriberlog.LogEntry _iter11 : this.messages)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  public static class Log_result implements TBase<Log_result, Log_result._Fields>, java.io.Serializable, Cloneable   {
     ...
     */
    public scriberlog.ResultCode success;
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT,
          new EnumMetaData(TType.ENUM, scriberlog.ResultCode.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
     ...
     * @see scriberlog.ResultCode
     */
    public scriberlog.ResultCode getSuccess() {
      return this.success;
    }
     ...
     * @see scriberlog.ResultCode
     */
    public Log_result setSuccess(scriberlog.ResultCode success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((scriberlog.ResultCode)value);
        }
        break;
        ...
        switch (field.id) {
          case 0: // SUCCESS
            if (field.type == TType.I32) {
              this.success = scriberlog.ResultCode.findByValue(iprot.readI32());
            } else {
              TProtocolUtil.skip(iprot, field.type);
            }
            break;
  ...
  public static class Log2_args implements TBase<Log2_args, Log2_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public Log2_args setMessages(List<scriberlog.LogEntry> messages) {
      this.messages = messages;
      return this;
    }
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.messages = new ArrayList<scriberlog.LogEntry>(_list12.size);
                for (int _i13 = 0; _i13 < _list12.size; ++_i13)
                {
                  scriberlog.LogEntry _elem14;
                  _elem14 = new scriberlog.LogEntry();
                  _elem14.read(iprot);
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.messages != null) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.messages.size()));
          for (scriberlog.LogEntry _iter15 : this.messages)
          {
            _iter15.write(oprot);
          }
          oprot.writeListEnd();
